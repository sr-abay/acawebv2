...
//Publications
const publications = [
    {name: 'Distributed Energy Resource Management System (DERMS) Cybersecurity Scenarios, Trends, and Potential Technologies: A Review', publication: 'IEEE Communications Surveys & Tutorials', year: '2025', publisher: 'IEEE', authors: '' },
    {name: 'Geomagnetic Storm Forecasting Using Machine Learning Models', publication: '2024 IEEE 14th Annual Computing and Communication Workshop and Conference (CCWC)', year: '2024', publisher: 'IEEE', authors: '' },
    {name: 'Designing Effective Cybersecurity Curriculum: Bridging Disciplines for Next Generation Workforce', publication: '', year: '2024', publisher: 'ASEE', authors: '' },
    {name: 'Transformer neural networks for intrusion diagnostic unit (idu) and anomaly detection in distributed energy resources (ders)', publication: '2024 7th International Conference on Electrical Engineering and Green Energy (CEEGE)', year: '2024', publisher: 'IEEE', authors: '' },
    {name: 'Malware Worm Attacks in Distributed Energy Resources (DERs)​', publication: '', year: '2024', publisher: 'UND Scholarly Commons', authors: '' },
    {name: 'Digital Twin Models for Cybersecurity Use Cases in Water Utilities and SCADA Systems: A Review', publication: '2024 Cyber Awareness and Research Symposium (CARS)', year: '2024', publisher: 'IEEE', authors: '' },
    {name: 'Lessons from the CrowdStrike Incident: Assessing Endpoint Security Vulnerabilities and Implications', publication: '2024 Cyber Awareness and Research Symposium (CARS)', year: '2024', publisher: 'IEEE', authors: '' },
    {name: 'Virtual Power Plants Security Challenges, Solutions, and Emerging Trends: A Review', publication: '2024 Cyber Awareness and Research Symposium (CARS)', year: '2024', publisher: 'IEEE', authors: '' },
    {name: 'Correlation of Egg counts, Micro-nutrients, and NDVI Distribution for Accurate Tracking of SCN Population Density Detection', publication: '2023 IEEE International Conference on Electro Information Technology (eIT)', year: '2023', publisher: 'IEEE', authors: '' },
    {name: 'Cybersecurity Challenges and Solutions in IoT-based Precision Farming Systems', publication: '2023 IEEE 14th Annual Ubiquitous Computing, Electronics & Mobile Communication Conference (UEMCON)', year: '2023', publisher: 'IEEE', authors: '' },
]